...
Se recomienta usar algun servidor como   **[Surge.sh](https://surge.sh/)** para publicar contenido y tener un enlace para su evaluación. Asimismo, se puede subir el contenido al repositorio. Figma Make tiene su propio sitio de alojamiento. 
